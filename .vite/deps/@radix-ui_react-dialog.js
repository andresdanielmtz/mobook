...
import {
  ...
  require_jsx_runtime,
  useComposedRefs,
} from "./chunk-LRALEFCY.js";
import { require_react_dom } from "./chunk-5HNGYYSW.js";
import { __assign, __rest, __spreadArray } from "./chunk-X4F27EZA.js";
...
function createContextScope(scopeName, createContextScopeDeps = []) {
  ...
  function createContext32(rootComponentName, defaultContext) {
    ...
    const Provider = (props) => {
      ...
      const Context =
        ((_a = scope == null ? void 0 : scope[scopeName]) == null
          ? void 0
          : _a[index]) || BaseContext;
      const value = React.useMemo(() => context, Object.values(context));
      return (0, import_jsx_runtime.jsx)(Context.Provider, { value, children });
    };
    Provider.displayName = rootComponentName + "Provider";
  ...
  const createScope = () => {
    ...
    return function useScope(scope) {
      const contexts =
        (scope == null ? void 0 : scope[scopeName]) || scopeContexts;
...
var useInsertionEffect =
  React5[" useInsertionEffect ".trim().toString()] || useLayoutEffect2;
  ...
  const setValue = React5.useCallback(
    (nextValue) => {
      ...
      if (isControlled) {
        ...
        if (value2 !== prop) {
          (_a = onChangeRef.current) == null
            ? void 0
            : _a.call(onChangeRef, value2);
        }
      } else {
    ...
    if (slottable) {
      ...
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          ...
          return React6.isValidElement(newElement)
      ...
      return (0, import_jsx_runtime2.jsx)(SlotClone, {
        ...slotProps,
        ref: forwardedRef,
        children: React6.isValidElement(newElement)
          ? React6.cloneElement(newElement, void 0, newChildren)
          : null,
      });
    }
    return (0, import_jsx_runtime2.jsx)(SlotClone, {
...
function createSlotClone(ownerName) {
  const SlotClone = React6.forwardRef((props, forwardedRef) => {
    ...
    return React6.Children.count(children) > 1
      ? React6.Children.only(null)
      : null;
  });
...
function getElementRef(element) {
  var _a, _b;
  let getter =
    (_a = Object.getOwnPropertyDescriptor(element.props, "ref")) == null
      ? void 0
      : _a.get;
  ...
  getter =
    (_b = Object.getOwnPropertyDescriptor(element, "ref")) == null
      ? void 0
      : _b.get;
...
function useCallbackRef(callback) {
  ...
  return React8.useMemo(
    () =>
      (...args) => {
        var _a;
        return (_a = callbackRef.current) == null
          ? void 0
          : _a.call(callbackRef, ...args);
      },
    [],
  );
}
    ...
    if (slottable) {
      ...
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          ...
          return React11.isValidElement(newElement)
            ? newElement.props.children
            : null;
        } else {
          return child;
      ...
      return (0, import_jsx_runtime5.jsx)(SlotClone, {
        ...slotProps,
        ref: forwardedRef,
        children: React11.isValidElement(newElement)
          ? React11.cloneElement(newElement, void 0, newChildren)
          : null,
      });
    }
    return (0, import_jsx_runtime5.jsx)(SlotClone, {
...
function createSlotClone2(ownerName) {
  const SlotClone = React11.forwardRef((props, forwardedRef) => {
    ...
    return React11.Children.count(children) > 1
      ? React11.Children.only(null)
      : null;
  });
  SlotClone.displayName = `${ownerName}.SlotClone`;
  return SlotClone;
...
function isSlottable2(child) {
  return (
    React11.isValidElement(child) &&
    typeof child.type === "function" &&
    "__radixId" in child.type &&
    child.type.__radixId === SLOTTABLE_IDENTIFIER2
  );
}
...
var Primitive2 = NODES2.reduce((primitive, node) => {
  ...
  const Node = React12.forwardRef((props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime6.jsx)(Comp, {
      ...primitiveProps,
      ref: forwardedRef,
    });
  });
...
var FocusScope = React13.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime7.jsx)(Primitive2.div, {
    tabIndex: -1,
    ...scopeProps,
    ref: composedRefs,
...
function createSlot3(ownerName) {
  ...
  const Slot22 = React14.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React14.Children.count(newElement) > 1)
            return React14.Children.only(null);
          return React14.isValidElement(newElement)
            ? newElement.props.children
            : null;
        } else {
          return child;
      ...
      return (0, import_jsx_runtime8.jsx)(SlotClone, {
        ...slotProps,
        ref: forwardedRef,
        children: React14.isValidElement(newElement)
          ? React14.cloneElement(newElement, void 0, newChildren)
          : null,
      });
    }
    return (0, import_jsx_runtime8.jsx)(SlotClone, {
...
function createSlotClone3(ownerName) {
  const SlotClone = React14.forwardRef((props, forwardedRef) => {
    ...
    return React14.Children.count(children) > 1
      ? React14.Children.only(null)
      : null;
  });
  SlotClone.displayName = `${ownerName}.SlotClone`;
  return SlotClone;
...
function isSlottable3(child) {
  return (
    React14.isValidElement(child) &&
    typeof child.type === "function" &&
    "__radixId" in child.type &&
    child.type.__radixId === SLOTTABLE_IDENTIFIER3
  );
}
...
var Primitive3 = NODES3.reduce((primitive, node) => {
  ...
  const Node = React15.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot5 : node;
    if (typeof window !== "undefined") {
      window[Symbol.for("radix-ui")] = true;
    }
    return (0, import_jsx_runtime9.jsx)(Comp, {
      ...primitiveProps,
      ref: forwardedRef,
    });
  });
...
var Portal = React16.forwardRef((props, forwardedRef) => {
  ...
  return container
    ? import_react_dom.default.createPortal(
        (0, import_jsx_runtime10.jsx)(Primitive3.div, {
          ...portalProps,
          ref: forwardedRef,
        }),
        container,
...
var Presence = (props) => {
  ...
  return forceMount || presence.isPresent
    ? React23.cloneElement(child, { ref })
    : null;
};
...
var useIsomorphicLayoutEffect =
  typeof window !== "undefined" ? React19.useLayoutEffect : React19.useEffect;
...
var RemoveScroll = React25.forwardRef(function (props, parentRef) {
  ...
  return React25.createElement(
    ...
    null,
    enabled &&
      React25.createElement(SideCar2, {
        sideCar: effectCar,
        removeScrollBar,
        shards,
        noRelative,
...
var RemoveScrollBar = function (_a) {
  ...
  useLockAttribute();
  var gap = React27.useMemo(
    function () {
      return getGapWidth(gapMode);
    },
    [gapMode],
  );
  return React27.createElement(Style, {
    styles: getStyles(
      gap,
      !noRelative,
      gapMode,
...
function RemoveScrollSideCar(props) {
  ...
  var shouldCancel = React28.useCallback(function (
    name,
    delta,
    target,
    should,
  ...
  return React28.createElement(
    ...
    removeScrollBar
      ? React28.createElement(RemoveScrollBar, {
          noRelative: props.noRelative,
          gapMode: props.gapMode,
        })
      : null,
...
var Dialog = (props) => {
  ...
  return (0, import_jsx_runtime11.jsx)(DialogProvider, {
    scope: __scopeDialog,
    triggerRef,
    contentRef,
    contentId: useId(),
    ...
    onOpenToggle: React30.useCallback(
...
var DialogTrigger = React30.forwardRef((props, forwardedRef) => {
  const { __scopeDialog, ...triggerProps } = props;
  const context = useDialogContext(TRIGGER_NAME, __scopeDialog);
  const composedTriggerRef = useComposedRefs(forwardedRef, context.triggerRef);
  return (0, import_jsx_runtime11.jsx)(Primitive.button, {
    type: "button",
...
var DialogPortal = (props) => {
  ...
  return (0, import_jsx_runtime11.jsx)(PortalProvider, {
    scope: __scopeDialog,
    forceMount,
    children: React30.Children.map(children, (child) =>
      (0, import_jsx_runtime11.jsx)(Presence, {
        present: forceMount || context.open,
        children: (0, import_jsx_runtime11.jsx)(Portal, {
          asChild: true,
          container,
          children: child,
        }),
...
var DialogOverlay = React30.forwardRef((props, forwardedRef) => {
  ...
  return context.modal
    ? (0, import_jsx_runtime11.jsx)(Presence, {
        present: forceMount || context.open,
        children: (0, import_jsx_runtime11.jsx)(DialogOverlayImpl, {
          ...overlayProps,
          ref: forwardedRef,
        }),
      })
...
var DialogOverlayImpl = React30.forwardRef((props, forwardedRef) => {
  const { __scopeDialog, ...overlayProps } = props;
  const context = useDialogContext(OVERLAY_NAME, __scopeDialog);
  return (
    // Make sure `Content` is scrollable even when it doesn't live inside `RemoveScroll`
    // ie. when `Overlay` and `Content` are siblings
    (0, import_jsx_runtime11.jsx)(Combination_default, {
      as: Slot4,
      allowPinchZoom: true,
      shards: [context.contentRef],
      children: (0, import_jsx_runtime11.jsx)(Primitive.div, {
        "data-state": getState(context.open),
        ...overlayProps,
        ref: forwardedRef,
...
var DialogContent = React30.forwardRef((props, forwardedRef) => {
  const portalContext = usePortalContext(CONTENT_NAME, props.__scopeDialog);
  const { forceMount = portalContext.forceMount, ...contentProps } = props;
  const context = useDialogContext(CONTENT_NAME, props.__scopeDialog);
  return (0, import_jsx_runtime11.jsx)(Presence, {
    present: forceMount || context.open,
    children: context.modal
      ? (0, import_jsx_runtime11.jsx)(DialogContentModal, {
          ...contentProps,
          ref: forwardedRef,
        })
      : (0, import_jsx_runtime11.jsx)(DialogContentNonModal, {
          ...contentProps,
          ref: forwardedRef,
        }),
  });
...
var DialogContentModal = React30.forwardRef((props, forwardedRef) => {
  const context = useDialogContext(CONTENT_NAME, props.__scopeDialog);
  const contentRef = React30.useRef(null);
  ...
  return (0, import_jsx_runtime11.jsx)(DialogContentImpl, {
    ...props,
    ref: composedRefs,
...
var DialogContentNonModal = React30.forwardRef((props, forwardedRef) => {
  const context = useDialogContext(CONTENT_NAME, props.__scopeDialog);
  ...
  return (0, import_jsx_runtime11.jsx)(DialogContentImpl, {
    ...
    onInteractOutside: (event) => {
      ...
      const targetIsTrigger =
        (_b = context.triggerRef.current) == null
          ? void 0
          : _b.contains(target);
...
var DialogContentImpl = React30.forwardRef((props, forwardedRef) => {
  const {
    __scopeDialog,
    trapFocus,
    onOpenAutoFocus,
  ...
  return (0, import_jsx_runtime11.jsxs)(import_jsx_runtime11.Fragment, {
    children: [
      (0, import_jsx_runtime11.jsx)(FocusScope, {
        asChild: true,
        loop: true,
        trapped: trapFocus,
        onMountAutoFocus: onOpenAutoFocus,
        onUnmountAutoFocus: onCloseAutoFocus,
        children: (0, import_jsx_runtime11.jsx)(DismissableLayer, {
          role: "dialog",
      ...
      (0, import_jsx_runtime11.jsxs)(import_jsx_runtime11.Fragment, {
        children: [
          (0, import_jsx_runtime11.jsx)(TitleWarning, {
            titleId: context.titleId,
          }),
          (0, import_jsx_runtime11.jsx)(DescriptionWarning, {
            contentRef,
...
var DialogTitle = React30.forwardRef((props, forwardedRef) => {
  const { __scopeDialog, ...titleProps } = props;
  const context = useDialogContext(TITLE_NAME, __scopeDialog);
  return (0, import_jsx_runtime11.jsx)(Primitive.h2, {
    id: context.titleId,
    ...titleProps,
    ref: forwardedRef,
  });
...
var DialogDescription = React30.forwardRef((props, forwardedRef) => {
  const { __scopeDialog, ...descriptionProps } = props;
  const context = useDialogContext(DESCRIPTION_NAME, __scopeDialog);
  return (0, import_jsx_runtime11.jsx)(Primitive.p, {
...
var DialogClose = React30.forwardRef((props, forwardedRef) => {
...
var DescriptionWarning = ({ contentRef, descriptionId }) => {
  ...
  React30.useEffect(() => {
    var _a;
    const describedById =
      (_a = contentRef.current) == null
        ? void 0
        : _a.getAttribute("aria-describedby");
