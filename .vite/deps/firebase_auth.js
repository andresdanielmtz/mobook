import { __rest } from "./chunk-X4F27EZA.js";
import {
  Component,
  ErrorFactory,
  FirebaseError,
...
async function _performApiRequest(
  ...
  return _performFetchWithErrorHandling(auth, customErrorMap, async () => {
    ...
    const query = querystring(
      Object.assign({ key: auth.config.apiKey }, params),
    ).slice(1);
...
var UserImpl = class _UserImpl {
  ...
  static _fromJSON(auth, object) {
    ...
    const displayName =
      (_a = object.displayName) !== null && _a !== void 0 ? _a : void 0;
    const email = (_b = object.email) !== null && _b !== void 0 ? _b : void 0;
    const phoneNumber =
      (_c = object.phoneNumber) !== null && _c !== void 0 ? _c : void 0;
    const photoURL =
      (_d = object.photoURL) !== null && _d !== void 0 ? _d : void 0;
    const tenantId =
      (_e = object.tenantId) !== null && _e !== void 0 ? _e : void 0;
    const _redirectEventId =
      (_f = object._redirectEventId) !== null && _f !== void 0 ? _f : void 0;
    const createdAt =
      (_g = object.createdAt) !== null && _g !== void 0 ? _g : void 0;
    const lastLoginAt =
      (_h = object.lastLoginAt) !== null && _h !== void 0 ? _h : void 0;
    const {
      uid,
      emailVerified,
      isAnonymous,
...
var PasswordPolicyImpl = class {
  constructor(response) {
    ...
    this.customStrengthOptions.minPasswordLength =
      (_a = responseOptions.minPasswordLength) !== null && _a !== void 0
        ? _a
    ...
    this.allowedNonAlphanumericCharacters =
      (_c =
        (_b = response.allowedNonAlphanumericCharacters) === null ||
        _b === void 0
          ? void 0
    ...
    this.forceUpgradeOnSignin =
      (_d = response.forceUpgradeOnSignin) !== null && _d !== void 0
        ? _d
        : false;
  ...
  validatePassword(password) {
    ...
    status.isValid &&
      (status.isValid =
        (_a = status.meetsMinPasswordLength) !== null && _a !== void 0
          ? _a
          : true);
    status.isValid &&
      (status.isValid =
        (_b = status.meetsMaxPasswordLength) !== null && _b !== void 0
          ? _b
          : true);
    status.isValid &&
      (status.isValid =
        (_c = status.containsLowercaseLetter) !== null && _c !== void 0
          ? _c
          : true);
    status.isValid &&
      (status.isValid =
        (_d = status.containsUppercaseLetter) !== null && _d !== void 0
          ? _d
          : true);
    status.isValid &&
      (status.isValid =
        (_e = status.containsNumericCharacter) !== null && _e !== void 0
          ? _e
          : true);
    status.isValid &&
      (status.isValid =
        (_f = status.containsNonAlphanumericCharacter) !== null && _f !== void 0
          ? _f
          : true);
    return status;
  }
...
var AuthImpl = class {
  ...
  _initializeWithPersistence(persistenceHierarchy, popupRedirectResolver) {
    ...
    this._initializationPromise = this.queue(async () => {
      ...
      (_a = this._resolvePersistenceManagerAvailable) === null || _a === void 0
        ? void 0
        : _a.call(this);
      if (this._deleted) {
        return;
      ...
      if (
        (_b = this._popupRedirectResolver) === null || _b === void 0
          ? void 0
          : _b._shouldInitProactively
      ) {
        try {
      ...
      this.lastNotifiedUid =
        ((_c = this.currentUser) === null || _c === void 0 ? void 0 : _c.uid) ||
        null;
      if (this._deleted) {
        return;
      }
    ...
    if (popupRedirectResolver && this.config.authDomain) {
      ...
      const redirectUserEventId =
        (_a = this.redirectUser) === null || _a === void 0
          ? void 0
          : _a._redirectEventId;
      const storedUserEventId =
        futureCurrentUser === null || futureCurrentUser === void 0
          ? void 0
  ...
  notifyAuthListeners() {
    ...
    const currentUid =
      (_b =
        (_a = this.currentUser) === null || _a === void 0 ? void 0 : _a.uid) !==
        null && _b !== void 0
        ? _b
        : null;
  ...
  async _getAdditionalHeaders() {
    ...
    const heartbeatsHeader = await ((_a =
  ...
  async _getAppCheckToken() {
    ...
    const appCheckTokenResult = await ((_a =
      this.appCheckServiceProvider.getImmediate({ optional: true })) === null ||
    _a === void 0
      ? void 0
      : _a.getToken());
    if (
      appCheckTokenResult === null || appCheckTokenResult === void 0
        ? void 0
        : appCheckTokenResult.error
    ) {
      _logWarn(
        `Error while retrieving App Check token: ${appCheckTokenResult.error}`,
      );
    }
    return appCheckTokenResult === null || appCheckTokenResult === void 0
      ? void 0
...
var MockReCaptcha = class {
  ...
  reset(optWidgetId) {
    ...
    void ((_a = this._widgets.get(id)) === null || _a === void 0
      ? void 0
      : _a.delete());
  ...
  getResponse(optWidgetId) {
    ...
    const id = optWidgetId || _WIDGET_ID_START;
    return (
      ((_a = this._widgets.get(id)) === null || _a === void 0
        ? void 0
        : _a.getResponse()) || ""
    );
  }
...
async function handleRecaptchaFlow(
  ...
  if (recaptchaAuthProvider === "EMAIL_PASSWORD_PROVIDER") {
    if (
      (_a = authInstance._getRecaptchaConfig()) === null || _a === void 0
        ? void 0
        : _a.isProviderEnabled(
            "EMAIL_PASSWORD_PROVIDER",
            /* RecaptchaAuthProvider.EMAIL_PASSWORD_PROVIDER */
          )
    ) {
    ...
    if (
      (_b = authInstance._getRecaptchaConfig()) === null || _b === void 0
        ? void 0
        : _b.isProviderEnabled(
            "PHONE_PROVIDER",
            /* RecaptchaAuthProvider.PHONE_PROVIDER */
          )
    ) {
      ...
      return actionMethod(authInstance, requestWithRecaptcha).catch(
        async (error) => {
          var _a2;
          if (
            ((_a2 = authInstance._getRecaptchaConfig()) === null ||
            _a2 === void 0
              ? void 0
              : _a2.getProviderEnforcementState(
                  "PHONE_PROVIDER",
                  /* RecaptchaAuthProvider.PHONE_PROVIDER */
                )) === "AUDIT"
          ) {
...
function connectAuthEmulator(auth, url, options) {
  ...
  const disableWarnings = !!(options === null || options === void 0
    ? void 0
...
var EmailAuthCredential = class _EmailAuthCredential extends AuthCredential {
  ...
  static fromJSON(json) {
    ...
    if (
      ...
      (obj === null || obj === void 0 ? void 0 : obj.password)
    ) {
...
var PhoneAuthCredential = class _PhoneAuthCredential extends AuthCredential {
  ...
  /** @internal */
  _linkToIdToken(auth, idToken) {
    return linkWithPhoneNumber$1(
      auth,
      Object.assign({ idToken }, this._makeVerificationRequest()),
    );
  }
  /** @internal */
  _getReauthenticationResolver(auth) {
...
var OAuthProvider = class _OAuthProvider extends BaseOAuthProvider {
  ...
  credential(params) {
    return this._credential(
      Object.assign(Object.assign({}, params), { nonce: params.rawNonce }),
    );
  }
  ...
  static credentialFromError(error) {
    return _OAuthProvider.oauthCredentialFromTaggedObject(
      error.customData || {},
    );
  }
...
var SAMLAuthProvider = class _SAMLAuthProvider extends FederatedAuthProvider {
   ...
   */
  static credentialFromError(error) {
    return _SAMLAuthProvider.samlCredentialFromTaggedObject(
      error.customData || {},
    );
  }
  /**
...
async function signInAnonymously(auth) {
  ...
  if (
    (_a = authInternal.currentUser) === null || _a === void 0
      ? void 0
      : _a.isAnonymous
  ) {
...
function providerDataAsNames(providerData) {
  return new Set(
    providerData.map(({ providerId }) => providerId).filter((pid) => !!pid),
  );
}
...
async function _assertLinkedStatus(expected, user, provider) {
  ...
  const code =
    expected === false ? "provider-already-linked" : "no-such-provider";
...
function _setActionCodeSettingsOnRequest(auth, request, actionCodeSettings) {
  var _a;
  _assert(
    ((_a = actionCodeSettings.url) === null || _a === void 0
      ? void 0
      : _a.length) > 0,
    auth,
    "invalid-continue-uri",
...
async function checkActionCode(auth, oobCode) {
  ...
  return {
    data: {
      email:
        (response.requestType === "VERIFY_AND_CHANGE_EMAIL"
          ? response.newEmail
          : response.email) || null,
      previousEmail:
        (response.requestType === "VERIFY_AND_CHANGE_EMAIL"
...
function isSignInWithEmailLink(auth, emailLink) {
  const actionCodeUrl = ActionCodeURL.parseLink(emailLink);
  return (
    (actionCodeUrl === null || actionCodeUrl === void 0
      ? void 0
      : actionCodeUrl.operation) === "EMAIL_SIGNIN"
  );
}
...
async function updateProfile(user, { displayName, photoURL: photoUrl }) {
  ...
  const response = await _logoutIfInvalidated(
    userInternal,
    updateProfile$1(userInternal.auth, profileRequest),
  );
...
async function updateEmailOrPassword(user, email, password) {
  ...
  const response = await _logoutIfInvalidated(
    user,
    updateEmailPassword(auth, request),
  );
  await user._updateTokensIfNecessary(
    response,
    /* reload */
...
function _fromIdTokenResponse(idTokenResponse) {
  ...
  if (
    !providerId &&
    (idTokenResponse === null || idTokenResponse === void 0
      ? void 0
      : idTokenResponse.idToken)
  ) {
    const signInProvider =
      (_b =
        (_a = _parseToken(idTokenResponse.idToken)) === null || _a === void 0
          ? void 0
          : _a.firebase) === null || _b === void 0
        ? void 0
        : _b["sign_in_provider"];
    if (signInProvider) {
      const filteredProviderId =
        signInProvider !== "anonymous" && signInProvider !== "custom"
          ? signInProvider
          : null;
...
var GithubAdditionalUserInfo = class extends FederatedAdditionalUserInfoWithUsername {
  constructor(isNewUser, profile) {
    super(
      ...
      "github.com",
      profile,
      typeof (profile === null || profile === void 0
        ? void 0
...
var MultiFactorSessionImpl = class _MultiFactorSessionImpl {
  ...
  static fromJSON(obj) {
    ...
    if (obj === null || obj === void 0 ? void 0 : obj.multiFactorSession) {
      if (
        (_a = obj.multiFactorSession) === null || _a === void 0
          ? void 0
          : _a.pendingCredential
      ) {
        return _MultiFactorSessionImpl._fromMfaPendingCredential(
          obj.multiFactorSession.pendingCredential,
        );
      } else if (
        (_b = obj.multiFactorSession) === null || _b === void 0
          ? void 0
          : _b.idToken
      ) {
        return _MultiFactorSessionImpl._fromIdtoken(
...
function getMultiFactorResolver(auth, error) {
  ...
  _assert(
    (_a = errorInternal.customData._serverResponse) === null || _a === void 0
      ? void 0
      : _a.mfaPendingCredential,
    authModular,
    "argument-error",
    /* AuthErrorCode.ARGUMENT_ERROR */
  );
...
function multiFactor(user) {
  ...
  if (!multiFactorUserCache.has(userModular)) {
    multiFactorUserCache.set(
      userModular,
      MultiFactorUserImpl._fromUser(userModular),
    );
  }
...
function getDocumentCookie(name2) {
  ...
  return (_b =
    (_a = document.cookie.match(matcher)) === null || _a === void 0
      ? void 0
      : _a[1]) !== null && _b !== void 0
    ? _b
    : null;
...
var IndexedDBLocalPersistence = class {
  ...
  async initializeSender() {
    ...
    if (
      ((_a = results[0]) === null || _a === void 0 ? void 0 : _a.fulfilled) &&
...
var ReCaptchaLoaderImpl = class {
  constructor() {
    ...
    this.hostLanguage = "";
    this.counter = 0;
    this.librarySeparatelyLoaded = !!((_a = _window().grecaptcha) === null ||
    _a === void 0
      ? void 0
      : _a.render);
  }
  ...
  shouldResolveImmediately(hl) {
    var _a;
    return (
      !!((_a = _window().grecaptcha) === null || _a === void 0
        ? void 0
        : _a.render) &&
...
async function signInWithPhoneNumber(auth, phoneNumber, appVerifier) {
  ...
  const verificationId = await _verifyPhoneNumber(
    authInternal,
    phoneNumber,
    getModularInstance(appVerifier),
  );
  ...
  try {
    ...
    if ("session" in phoneInfoOptions) {
      ...
      if ("phoneNumber" in phoneInfoOptions) {
        ...
        const startEnrollPhoneMfaActionCallback = async (
          authInstance,
          request,
        ) => {
          if (request.phoneEnrollmentInfo.captchaResponse === FAKE_TOKEN) {
            _assert(
              (verifier === null || verifier === void 0
                ? void 0
        ...
        const mfaEnrollmentId =
          ((_a = phoneInfoOptions.multiFactorHint) === null || _a === void 0
            ? void 0
            : _a.uid) || phoneInfoOptions.multiFactorUid;
        _assert(
          mfaEnrollmentId,
          auth,
          "missing-multi-factor-info",
        ...
        const startSignInPhoneMfaActionCallback = async (
          authInstance,
          request,
        ) => {
      ...
      const sendPhoneVerificationCodeActionCallback = async (
        authInstance,
        request,
      ) => {
...
var PopupOperation = class _PopupOperation extends AbstractPopupRedirectOperation {
  ...
  get eventId() {
    var _a;
    return (
      ((_a = this.authWindow) === null || _a === void 0
        ? void 0
        : _a.associatedEvent) || null
    );
  }
  cancel() {
    this.reject(
...
var BrowserPopupRedirectResolver = class {
  ...
  async _openPopup(auth, provider, authType, eventId) {
    var _a;
    debugAssert(
      (_a = this.eventManagers[auth._key()]) === null || _a === void 0
        ? void 0
        : _a.manager,
  ...
  _isIframeWebStorageSupported(auth, cb) {
    ...
    iframe.send(
      ...
      (result) => {
        var _a;
        const isSupported =
          (_a = result === null || result === void 0 ? void 0 : result[0]) ===
            null || _a === void 0
            ? void 0
...
var TotpMultiFactorGenerator = class {
  ...
  static async generateSecret(session) {
    ...
    _assert(
      typeof ((_a = mfaSession.user) === null || _a === void 0
        ? void 0
        : _a.auth) !== "undefined",
      "internal-error",
      /* AuthErrorCode.INTERNAL_ERROR */
...
function _isEmptyString(input) {
  return (
    ...
    (input === null || input === void 0 ? void 0 : input.length) === 0
  );
}
    ...
    const unsubscribe = this.auth.onIdTokenChanged((user) => {
      listener(
        (user === null || user === void 0
          ? void 0
          : user.stsTokenManager.accessToken) || null,
      );
    });
...
var mintCookieFactory = (url) => async (user) => {
  ...
  const idToken =
    idTokenResult === null || idTokenResult === void 0
      ? void 0
      : idTokenResult.token;
