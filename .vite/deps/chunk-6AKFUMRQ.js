...
function updateEmulatorBanner(name2, isRunningEmulator) {
  if (
    ...
    emulatorStatus[name2] || // If already set to use emulator, can't go back to prod.
    previouslyDismissed
  ) {
    return;
  }
  ...
  function setupDom() {
    ...
    const learnMoreLink =
      document.getElementById(learnMoreId) || document.createElement("a");
...
var FirebaseServerAppImpl = class extends FirebaseAppImpl {
  constructor(options, serverConfig, name2, container) {
    const automaticDataCollectionEnabled =
      serverConfig.automaticDataCollectionEnabled !== void 0
...
function initializeApp(_options, rawConfig = {}) {
  ...
  const config = Object.assign(
    { name: DEFAULT_ENTRY_NAME2, automaticDataCollectionEnabled: true },
    rawConfig,
  );
...
@firebase/app/dist/esm/index.esm2017.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-6AKFUMRQ.js.map
